-- Credits: https://github.com/manilarome/the-glorious-dotfiles/blob/master/config/awesome/linear/module/menu.lua
--
...
menu.build = function(args)
    ...
    local result     = {}
    local _menu      = awful.menu({ items = before })
...
mymainmenu = menu.build({
        ...
        after = {
            ...
            },
            {
                ...
                menu_utils.lookup_icon('system-shutdown')
            }
        }
    })
